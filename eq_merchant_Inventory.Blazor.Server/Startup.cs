...
using eq_merchant_Inventory.Blazor.Server.Services;
using DevExpress.Persistent.BaseImpl.EF.PermissionPolicy;
using eq_merchant_Inventory.Blazor.Server.Data;

namespace eq_merchant_Inventory.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<eq_merchant_InventoryBlazorApplication>();
            builder.Modules
                .AddAuditTrailEFCore()
                ...
                .AddViewVariants()
                .Add<eq_merchant_Inventory.Module.eq_merchant_InventoryModule>()
            	.Add<eq_merchant_InventoryBlazorModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                    .WithAuditedDbContext(contexts => {
                        contexts.Configure<eq_merchant_Inventory.Module.BusinessObjects.eq_merchant_InventoryEFCoreDbContext, eq_merchant_Inventory.Module.BusinessObjects.eq_merchant_InventoryAuditingDbContext>(
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(eq_merchant_Inventory.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(eq_merchant_Inventory.Module.BusinessObjects.ApplicationUserLoginInfo);
